...
const ModalTraditionalRatings = ({ notification, characteristics, initialValues, onCompleteStep, onBackStep }) => {
  ...
  const handleSubmit = () => {
    onCompleteStep(ratingsTraditional);
  }
  ...
  return (
    <div>
      ...
      <div className="border-t border-neutral-300 mt-12 mb-12">
      ...
      {notification && (
        ...
        <div className="flex justify-between">
          ...
          <div className="pt-10">
            <button onClick={handleSubmit} type="button" className="mt-5 h-11 inline-flex justify-self-center px-4 py-2.5 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-indigo-500">
              Submit rating
