...
const RatingReview = ({ initialValue, rateSelected }) => {
  ...
  const fullStar = (
    <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="star" className="w-10 h-10 mt-2 mr-6 ml-9 text-indigo-600" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
