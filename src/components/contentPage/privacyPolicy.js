  ...
  return (
    <div className="ml-4">
     ...
     <p className="text-normal text-neutral-700 mt-6">
      <strong className="font-semibold">Public Content: </strong>
      Your contributions to the Service (Ratings and Reviews) are intended for public consumption and are therefore viewable by the public.
      </p>
      <p className="text-normal text-neutral-700 mt-6 mb-2">
      <strong className="font-semibold">Professional Information: </strong>
      If you review and/or rate an employer on Peak, we will check your work email in order to validate your employment. This information is not stored in any way. Your job title and office location are not required but will be displayed with your review if entered. Other users may be able to identify you if you include personal information in the content you post publicly.      </p>
    </div>
  );
}
